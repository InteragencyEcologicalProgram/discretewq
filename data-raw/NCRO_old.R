...
# This script is meant to be an archive of the code used to prepare the NCRO
  # data collected from 1999-2022 and is sourced in the data-raw/NCRO_current.R
  # script to regenerate this data.
...
# Remove all objects except for final data frame
rm(list = ls()[ls() != "NCRO_1999_2022"])
