## code to prepare `NCRO` dataset from 1999-2022
# DO NOT EDIT THIS FILE
# This script is meant to be an archive of the code used to prepare the NCRO
  # data collected from 1999-2022 and produces an rds file of this data.
# Use the data-raw/NCRO_current.R script to continue updating the NCRO dataset.
...
# Define file path to data-raw/NCRO_old folder
fp_ncro_data <- "data-raw/NCRO_old"

# Create vectors of file paths of Excel and csv files within data-raw/NCRO_old folder
...
NCRO_secchi_mvi_2017_2022 <- read_excel(
  file.path(fp_ncro_data, "qry_HabObs_StationNameStationCode_DeployEnd_2017-2022.xlsx")
)

# Import station metadata and coordinates
stations <- read_csv(file.path(fp_ncro_data, "Stations.csv"))
...
secHABs <- NCRO_secchi_mvi_2017_2022 %>%
  mutate(
...
same_date_dups_rm <- read_csv(file.path(fp_ncro_data, "duplicates_same_date.csv")) %>%
...
corr_wq_meas <- read_csv(file.path(fp_ncro_data, "ncro_questionable_wq_meas_Verified.csv")) %>%
  select(
    SampleCode,
    Analyte,
...
NCRO_1999_2022 <- NCRO_all_c8_wide %>%
...
NCRO_1999_2022 %>% saveRDS("data-raw/NCRO_current/ncro_data_1999-2022.rds")
