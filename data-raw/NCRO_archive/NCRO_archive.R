...
# This script is meant to be an archive of the code used to prepare the NCRO data collected from
  # 1999-2022 and produces an rds file of this data.
# Use the data-raw/NCRO.R script to continue updating the NCRO dataset.
...
# Define file path to data-raw/NCRO_archive folder
fp_ncro_data <- "data-raw/NCRO_archive"

# Create vectors of file paths of Excel and csv files within data-raw/NCRO_archive folder
...
NCRO_secchi_mvi_2017_2022 <- read_excel(
  "data-raw/NCRO/qry_HabObs_StationNameStationCode_DeployEnd_2017-2022.xlsx"
)
